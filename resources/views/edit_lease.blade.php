        ...
        <div class="card-body">
            <form action="{{ route('lease_update', $lease->id) }}" enctype="multipart/form-data" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select name="property_id" id="property_id" required class="form-control" onchange="get_unit()">
                            ...
                            @endphp
                            <option value="{{ $property->id }}" @if ($property->id == $lease->property_id) selected
                                @endif>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" value="{{ $lease->start_date }}" name="start_date" id="start_date" required
                            class="form-control">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" value="{{ $lease->rent_amount }}" name="rent_amount" id="rent_amount" required
                        class="form-control">
                </div>
                <div class="col-md-6">
