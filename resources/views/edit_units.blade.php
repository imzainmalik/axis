                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select name="property_id" id="" required class="form-control">
                                ...
                                <option value="{{ $get_property->id }}" @if ($units->property_id == $get_property->id)
                                    selected @endif
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="is_available" id="is_available"
                                    checked value="1" @if ($units->is_available == 1) checked @endif>
                                <label class="form-check-label" for="is_available">
                                    No
                                </label>
                            </div>
                        ...
                        <div class="col-md-6">
                            <button class="red-btn">Update Unit</button>
                        </div>
                    </div>
                </form>
            </div>
