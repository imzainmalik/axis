...
@section('content')
        ...
        <div class="main-map">
            ...
            <div class="map-inner">
                <ul class="map-list1">
                    ...
                    <li>
                        <img src="{{ asset('assets/images/extra1.png') }}" alt="">
                    </li>
                    <li>
                        <a href="#" class="grey">
                    ...
                    <li>
                        <a href="#" class="blue">
                            <div class="bg-img"><img src="{{ asset('assets/images/extra2.png') }}" alt=""></div>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="yellow">
                    ...
                    <li>
                        <a href="#" class="blue">
                            <div class="bg-img"><img src="{{ asset('assets/images/extra3.png') }}" alt=""></div>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="blue">
                ...
                <ul class="map-list2">
                    ...
                    <li>
                        <img src="{{ asset('assets/images/extra4.png') }}" alt="">
                        <a href="#" class="grey">
                    ...
                    <li>
                        ...
                        <img src="{{ asset('assets/images/extra5.png') }}" alt="">
                    </li>
                    <li>
                        <a href="#" class="grey">
                    ...
                    <li>
                        ...
                        <img src="{{ asset('assets/images/extra6.png') }}" alt="">
                    </li>
                    <li>
                        <div class="white-space"></div>
                    </li>
                ...
                <ul class="map-list3">
                    ...
                    <li>
                        <img src="{{ asset('assets/images/extra7.png') }}" alt="">
                        <a href="#" class="grey">
                            <p>A31</p>
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        <img src="{{ asset('assets/images/extra8.png') }}" alt="">
                    </li>
                    <li>
                        <a href="#" class="yellow">
                    ...
                    <li>
                        ...
                        <img src="{{ asset('assets/images/extra9.png') }}" alt="">
                    </li>
                    <li>
                        <div class="white-space"></div>
                    </li>
                    <li>
                        <img src="{{ asset('assets/images/extra10.png') }}" alt="">
                        <a href="#" class="grey">
                            <p>A51</p>
                        </a>
                    </li>
                ...
                <div class="m-bdr1"><img src="{{ asset('assets/images/m-bdr1.png') }}" alt=""></div>
                <div class="m-bdr2"><img src="{{ asset('assets/images/m-bdr2.png') }}" alt=""></div>
            </div>
    ...
    @foreach ($units as $item)
        @php
            $tenants = App\Models\Tenant::where('unit_id', $item->id)->first();
        @endphp
